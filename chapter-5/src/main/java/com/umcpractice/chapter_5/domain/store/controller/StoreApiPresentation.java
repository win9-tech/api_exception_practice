...
public interface StoreApiPresentation {
    ...
    ApiResponse<MissionResponse.MissionPreViewListDTO> getMissionList(@StoreExists @PathVariable(name = "storeId") Long storeId, @PageAvailable @RequestParam(name = "page") Integer page);
}
